...
system('clear');
echo "[]==================================[]\n";
echo "[] => Author   : MR.BksMilenial     []\n";
echo "[] => Nama     : ./Zarel.IT         []\n";
echo "[] => Youtube  : RelGanz            []\n";
echo "[] => Facebook : -                  []\n";
echo "[] => Intagram : @./Zarel.IT.       []\n";
echo "[] => github   : -                  []\n";
echo "[]==================================[]\n";
...
echo "Apakah Benar ini $nomer No Target? (y/n)";
$cek = trim(fgets(STDIN));
if($cek=="n") exit("Stopped!\n");
echo "Masukan Jumlah Yang Mau Di Kirim >> ";
